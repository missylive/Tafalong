...
if ((isset($_GET['no'])) && ($_GET['no'] != "")) {
  $deleteSQL = sprintf("DELETE FROM company WHERE `no`=%s",
...
$show_company = mysql_query($query_show_company, $dbconnect) or die(mysql_error());
$row_show_company = mysql_fetch_assoc($show_company);
$totalRows_show_company = mysql_num_rows($show_company);
?>
            ...
            <div style="margin:auto; width:900px;">
            	<table width="100%" height="487" border="0" cellpadding="6" cellspacing="1" id="tb01" style="height:450px;">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td><a class="button">編輯</a></td>
                    <td width="10%" ><a class="button_grey" onclick="tfm_confirmLink('確定刪除資料?');return document.MM_returnValue">刪除</a></td>
                  </tr>
<tr>
            <td>&nbsp;</td>
					<td colspan="2" align="right">&nbsp;  到  共 </td>
					<td colspan="3">&nbsp;
                      <table border="0">
                        <tr>
                          <td> 第一頁 </td>
