...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO video (type, title, website, content) VALUES (%s, %s, %s, %s)",
    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="videoAdd.php" class="current"><span>新增影片</span></a></li>
...
<!-- CONTENT START -->
   ...
   <!-- CONTENT TITLE -->
    <div class="grid_9">
    <h1 class="content_edit">新增影音分享</h1>
            ...
            <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
            	<table width="100%" border="0" cellpadding="6" cellspacing="1" id="tb01" >
                  ...
                  <tr>
                    ...
                    <td width="30%" class="even"><input  name="title"  type="text" value="" size="40"/></td>
                    <td width="8%" align="right" valign="top" class="even">網址</td>
                    <td width="46%" class="even"><input  name="webside"  type="text" value="" size="40"/></td>
                  </tr>
                  <tr>
                    <td height="48" align="right" valign="top" class="even">簡介</td>
                    <td colspan="3" class="even"><textarea name="content" cols="75" rows="2"></textarea></td>
                  </tr>
<tr>
              <td class="even"></td>
              <td class="even"></td>                    
