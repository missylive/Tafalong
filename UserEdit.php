...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ``user`` SET password=%s, name=%s, phone=%s, mobile=%s, email=%s, email2=%s, address=%s, other=%s WHERE id=%s",
...
mysql_select_db($database_dbconnect, $dbconnect);
$query_users = sprintf("SELECT * FROM `user` WHERE id = %s", GetSQLValueString($colname_users, "text"));
...
<!-- HIDDEN COLOR CHANGER -->
    ...
    <div class="grid_8">
<!-- USER TOOLS START -->      
      <div id="user_tools"><span><a href="#" class="mail">(1)</a> 歡迎來到後台管理 <a href="UserEdit.php">Admin</a>  |  <?php if (strtolower($_SESSION['MM_Username'])=='admin') { ?><a class="dropdown" href="users.php">管理會員資料</a><?php }?>  |  <a href="<?php echo $logoutAction ?>">登出</a></span></div>
    </div>
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
        <table width="872" height="453" align="center">
          <tr valign="baseline">
            ...
            <td width="572"><input name="id" type="text" id="id" value="<?php echo $row_users['id']; ?>" size="40" readonly="readonly" /></td>
          </tr>
          <tr valign="baseline">
            <td><a class="me">密碼</a></td>
            <td><input name="UserPWD" type="PASSWORD" id="UserPWD" value="<?php echo $row_users['password']; ?>" size="40"/></td>
          </tr>
          <tr valign="baseline">

            <td nowrap="nowrap" align="right"><a class="me">重複輸入密碼</a></td>
            <td><input name="password" type="PASSWORD" id="password" value="<?php echo $row_users['password']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">管理員名稱</a></td>
            <td><input name="name" type="text" id="name" value="<?php echo $row_users['name']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">電話</a></td>
            <td><input type="text" name="phone" value="<?php echo $row_users['phone']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">手機</a></td>
            <td><input name="mobile" type="text" id="mobile" value="<?php echo $row_users['mobile']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">電子信箱</a></td>
            <td><input name="email" type="text" id="email" value="<?php echo $row_users['email']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">備用信箱</a></td>
            <td><input type="text" name="email2" value="<?php echo $row_users['email2']; ?>" size="40" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right"><a class="me">居住地址</a></td>
            <td><input type="text" name="address" value="<?php echo $row_users['address']; ?>" size="80" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">備註Other:</td>
            <td><textarea name="other" cols="61" rows="3" type="text" value="" ><?php echo $row_users['other']; ?></textarea></td>
          </tr>
          <tr valign="baseline">
