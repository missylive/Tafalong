...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	move_uploaded_file($_FILES["pic"]["tmp_name"],"pictures\Article\\" .$_FILES["pic"]["name"]);
  $insertSQL = sprintf("INSERT INTO mix (type, title, content, pic) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['type'], "text"),
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['content'], "text"),
                       GetSQLValueString("administrator/Pictures/Article/" . $_FILES["pic"]["name"], "text"));
    ...
    <div id="tabs">
         <div class="container">
            <ul>
             ...
             <li><a href="article_Add.php" class="current"><span>新增文章</span></a></li>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1"  enctype="multipart/form-data">
          <table width="819"  align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="title" value="" size="120" /></td>
            </tr>
            <tr valign="baseline">
              <td align="center" valign="middle" nowrap="nowrap"><strong>文章內容:</strong></td>
              <td><textarea name="content" cols="91" rows="20"  ></textarea></td>
            </tr>
            <tr valign="baseline">
