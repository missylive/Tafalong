...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	move_uploaded_file($_FILES["pic"]["tmp_name"],"pictures\News\\" .$_FILES["pic"]["name"]);
  $insertSQL = sprintf("INSERT INTO news (type, title, content, pic, startdate, endate, place) VALUES (%s, %s, %s, %s, %s, %s,  %s)",
                       GetSQLValueString($_POST['type'], "text"),
                       GetSQLValueString($_POST['title'], "text"),
                       GetSQLValueString($_POST['content'], "text"),
                       GetSQLValueString("pictures/News/" . $_FILES["pic"]["name"], "text"),
    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="newsAdd.php" class="current"><span>新增最新消息及活動</span></a></li>
...
<!-- CONTENT START -->
   ...
   <!-- CONTENT TITLE -->
    <div class="grid_9">
    <h1 class="content_edit">新增最新消息及活動
              ...
              <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1" enctype="multipart/form-data">
                <table width="900" height="363" align="center">
                  ...
                  <tr valign="baseline">
                    ...
                    <td colspan="3"><input type="text" name="title" value="" size="116" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right" valign="middle" nowrap="nowrap">內容:</td>
                    <td colspan="3"><textarea name="content" cols="88" rows="6"></textarea></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right" valign="middle" nowrap="nowrap">圖片:</td>
                    <td colspan="3"><input name="pic" type="file"  id="pic"/></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right" valign="middle" nowrap="nowrap">開始日期:</td>
                    <td width="346"><input type="text" name="startdate" value="" size="46" id="datepicker"/></td>
                    <td width="66" align="right" valign="middle">結束日期:</td>
                    <td width="371"><input type="text" name="endate" value="" size="46" id="datepicker1"/></td>
                  </tr>
                  <tr valign="baseline">
                    <td align="right" valign="middle" nowrap="nowrap">地點:</td>
                    <td><input type="text" name="place" value="" size="46" /></td>
