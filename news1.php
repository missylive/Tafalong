    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="newsAdd.php"><span>新增最新消息</span></a></li>
   ...
   <!-- CONTENT TITLE -->
    ...
    <h1 class="content_edit">編輯最新消息</h1>
	   <p> 選擇您要修改的文章，編輯它。或按以下按鈕進入新增文章頁面。有任何問題請聯絡系統管理員。 </p>
   	   <p>刪除文章即無法復原，請確認您的文章必須刪除，刪除即無法救回資料。</p>
    ...
    <div class="grid_15" id="textcontent">
            <div style="margin:auto; width:900px;">
              <table width="100%" border="0" cellspacing="1" cellpadding="6" id="tb01" style="height:500px;">
                ...
                <?php do { ?>
                  <tr>
                      <td><?php echo $row_show_news['no']; ?></td>
                      <td><?php echo $row_show_news['type']; ?></td>
                      <td><?php echo $row_show_news['title']; ?></td>
                      <td><a class="button_grey_round" href="#"><img src="i/icon_zooms.png" width="14" height="16" border="0" style="vertical-align: middle;"/>&nbsp;即時預覽</a></td>
                      <td><a class="button" href="#"><img src="i/icon_settings2s.png" width="16" height="17" border="0" style="vertical-align: middle;"/>&nbsp;編輯</a></td>
