...
$query_show_mix_data = "SELECT `no`, type, title FROM mix WHERE type = 'festival' ORDER BY `no` DESC";
...
$(document).ready(function() {
		$('#wysiwyg').wysiwyg();
			...
			$("#FristDelete,#SecDelete,#ThreeDelete").click(function(){
		   
		     switch(this.id)
			 {
			   case 'FristDelete':
			     var GET = "DeleteFile.php?fileid=pic"
			     $.get(GET,function(DATA){
					...
					{
					   $("#BigPhoto").attr("src","i/outcomephoto-noview.gif");
					   $("#smallphoto_1").attr("src","i/no-view.jpg");
					   alert("刪除成功");
					}
			   ...
			   break;
			   case 'SecDelete':
			   var GET = "DeleteFile.php?fileid=pic_1"
			     $.get(GET,function(DATA){
					...
					{
					   $("#smallphoto_2").attr("src","i/no-view.jpg");
					   alert("刪除成功");
					}
			   ...
			   break;
			   case 'ThreeDelete':
			    var GET = "DeleteFile.php?fileid=pic_2"
			     $.get(GET,function(DATA){
					...
					{
					   $("#smallphoto_3").attr("src","i/no-view.jpg");
					   alert("刪除成功");
					}
...
function tfm_confirmLink(message) { //v1.0
    ...
    <script type="text/javascript" src="js/effects.js"></script>    <!--[if IE6]>
    ...
    <div id="tabs">
         <div class="container">
            <ul>
             ...
             <li><a href="article_festival.php" class="current"><span>節慶類文章</span></a></li>
...
<!-- CONTENT START -->
   ...
   <!-- CONTENT TITLE -->
    <div class="grid_9">
    <h1 class="content_edit">編輯節慶文章</h1>
...
<table width="100%" border="0" cellspacing="1" cellpadding="6" id="tb01" style="height:500px;">
            ...
            <tr>
              ...
              <td class="even"><?php echo $row_show_mix_data['type']; ?></td>
              <td class="even"><?php echo $row_show_mix_data['title']; ?></td>                    
              ...
              <td class="even"><a href="Delete/deleteFestival.php?no=<?php echo $row_show_mix_data['no']; ?>" class="button_grey" onclick="tfm_confirmLink('確定刪除資料?');return document.MM_returnValue">刪除<img src="i/icon_trash.png" width="16" height="16" border="0"  style="vertical-align: middle;"/></a></td>
            </tr>
