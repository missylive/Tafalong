...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "addgoods")) {
	...
	move_uploaded_file($_FILES["goods_img"]["tmp_name"],"pictures\shop\\" .$_FILES["goods_img"]["name"]);
    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="shop_goods.php" class="current"><span>新增商品上架</span></a></li>
...
<!-- CONTENT START -->
   ...
   <!-- CONTENT TITLE -->
    <h1 class="content_edit">新增商品上架</h1>
...
<!--    TEXT CONTENT OR ANY OTHER CONTENT START     -->
    <div>
    新增商品分類
      <form action="<?php echo $editFormAction; ?>" id="addgoods" name="addgoods" method="POST" enctype="multipart/form-data">
...
?>
  ...
  <tr>
    <td>商品圖片:</td>
    <td><input name="goods_img" type="file"  id="goods_img"/></td>
    <td>商品規格:</td>
    <td><input name="goods_stand" type="text" /></td>
  </tr>
  <tr>
    <td>商品說明:</td>
    <td colspan="3"><textarea name="goods_desc" cols="100" rows="5" wrap="physical">&nbsp;</textarea></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
