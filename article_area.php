...
$query_show_mix_data = "SELECT `no`, type, title FROM mix WHERE type = 'area' ORDER BY `no` DESC";
...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
             <li><a href="article_area.php" class="current"><span>太巴塱社區文章</span></a></li>
...
<!-- CONTENT START -->
   ...
   <!-- CONTENT TITLE -->
    <div class="grid_9">
    <h1 class="content_edit">編輯太巴塱社區</h1>
...
<table width="100%" border="0" cellspacing="1" cellpadding="6" id="tb01" style="height:500px;">
            ...
            <tr>
              ...
              <td class="even">
              <a href="Delete/deleteArea.php?no=<?php echo $row_show_mix_data['no']; ?>" title="Delete" class="button_grey" onclick="tfm_confirmLink('確定刪除資料?');return document.MM_returnValue">刪除<img src="i/icon_trash.png" width="16" height="16" border="0"  style="vertical-align: middle;"/></a></td>
            </tr>
